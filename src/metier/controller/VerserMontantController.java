...
public class VerserMontantController {
	@FXML
	...
	@FXML
	public void onVerser(ActionEvent event) {
		Parent root;
		if(tfCode.getText() != null && tfMontant.getText() !=null) {
			try {
				lookUpBanqueRemote().verser(Long.parseLong(tfCode.getText()), Double.parseDouble(tfMontant.getText()));
				tfCode.setText("");
				tfMontant.setText("");
