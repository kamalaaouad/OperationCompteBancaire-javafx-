...
public class RetierMontantController {
	@FXML
	...
	@FXML
	public void onRetirer(ActionEvent event) {
		Parent root;
		if(tfCode.getText()!=null && tfMontant.getText()!=null) {
			try {
				lookUpBanqueRemote().retirer(Long.parseLong(tfCode.getText()), Double.parseDouble(tfMontant.getText()));
				tfCode.setText("");
				tfMontant.setText("");
